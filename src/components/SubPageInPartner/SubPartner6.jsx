...
import img1 from "../../img/imgPartner/img6.webp"
...
const PostPage6 = () => {
  return (
    <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg mt-6">
      ...
      Hshop.vn là đại lý ủy quyền chính thức của Waveshare tại Việt Nam
      </h1>
      ...
      hiện Hshop.vn là đại lý ủy quyền chính thức của Waveshare tại Việt Nam với các sản phẩm Cảm biến, Module, Mạch Lập Trình,..., chi tiết xin xem tại link dưới đây:
      </p>

      {/* Phần tham khảo sản phẩm */}
      <h2 className="text-lg font-bold text-black mt-4">
      Asia / Vietnam: <a href="https://www.waveshare.com/distributors">https://www.waveshare.com/distributors</a>
      </h2>
      <p>
      Tham khảo các sản phẩm Waveshare đang phân phối tại Hshop.vn: <a href="Waveshare.com">Waveshare</a>
      </p>
